...
var mappingDescriptionHMDK = {"mappings":[
        {
            "execute": {
...
if (log.isDebugEnabled()) {
    log.debug("HMDK: mapping CSW 2.0.2 AP ISO 1.0 document to IGC import document.");
}

mapToTarget(mappingDescriptionHMDK, source, target.getDocumentElement());
