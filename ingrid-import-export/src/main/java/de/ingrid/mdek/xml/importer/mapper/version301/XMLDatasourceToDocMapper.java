package de.ingrid.mdek.xml.importer.mapper.version301;
...
public class XMLDatasourceToDocMapper extends AbstractXMLToDocMapper {
	...
	private static final String X_ADDITIONAL_DATA_LANGUAGE = "//data-source/additional-information/data-language/text()";
	private static final String X_ADDITIONAL_DATA_LANGUAGE_KEY = "//data-source/additional-information/data-language/@id";
	private static final String X_ADDITIONAL_METADATA_LANGUAGE = "//data-source/additional-information/metadata-language/text()";
	private static final String X_ADDITIONAL_METADATA_LANGUAGE_KEY = "//data-source/additional-information/metadata-language/@id";
	...
	private static final String X_SPATIAL_COORDINATE_SYSTEM = "//data-source/spatial-domain/coordinate-system/text()";
	private static final String X_SPATIAL_COORDINATE_SYSTEM_KEY = "//data-source/spatial-domain/coordinate-system/@id";
	...
	private static final String X_LINK_VOLUME = "linkage-volume/text()";
	private static final String X_LINK_ICON_URL = "linkage-icon-url/text()";
	private static final String X_LINK_ICON_TEXT = "linkage-icon-text/text()";
...
//		mapIntList(source, X_ENV_CATEGORIES, target, MdekKeys.ENV_CATEGORIES);
	...
	private static void mapServiceClassifications(Document source, IngridDocument target) {
		Node service = XPathUtils.getNode(source, X_TECHNICAL_DOMAIN_SERVICE);
	...
	private static void mapSpatialDomain(Document source, IngridDocument target) {
		putString(new String[] {MdekKeys.TECHNICAL_DOMAIN_MAP, MdekKeys.COORDINATE_SYSTEM},
				XPathUtils.getString(source, X_SPATIAL_COORDINATE_SYSTEM), target);
		putInt(new String[] {MdekKeys.TECHNICAL_DOMAIN_MAP, MdekKeys.REFERENCESYSTEM_ID},
				XPathUtils.getInt(source, X_SPATIAL_COORDINATE_SYSTEM_KEY), target);
	...
	private static void mapAvailableLinkages(Document source, IngridDocument target) {
		...
		for (int index = 0; index < linkages.getLength(); index++) {
			...
			putString(MdekKeys.LINKAGE_VOLUME, XPathUtils.getString(linkage, X_LINK_VOLUME), linkageDoc);
			putString(MdekKeys.LINKAGE_ICON_URL, XPathUtils.getString(linkage, X_LINK_ICON_URL), linkageDoc);
			putString(MdekKeys.LINKAGE_ICON_TEXT, XPathUtils.getString(linkage, X_LINK_ICON_TEXT), linkageDoc);
