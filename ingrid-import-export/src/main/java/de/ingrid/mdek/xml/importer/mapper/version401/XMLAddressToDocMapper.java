 ...
 * **************************************************#
 */
package de.ingrid.mdek.xml.importer.mapper.version401;
...
public class XMLAddressToDocMapper extends AbstractXMLToDocMapper {
	...
	private final static String X_ADMINISTRATIVE_AREA = X_ADDRESS + "/administrative-area/text()";
	private final static String X_ADMINISTRATIVE_AREA_KEY = X_ADDRESS + "/administrative-area/@id";
	...
	private final static String X_HOURS_OF_SERVICE = X_ADDRESS + "/hours-of-service/text()";
	...
	public static IngridDocument map(Document source) {
		...
		putString(MdekKeys.ADMINISTRATIVE_AREA_NAME, XPathUtils.getString(source, X_ADMINISTRATIVE_AREA), address);
		putInt(MdekKeys.ADMINISTRATIVE_AREA_CODE, XPathUtils.getInt(source, X_ADMINISTRATIVE_AREA_KEY), address);
		...
		putString(MdekKeys.HOURS_OF_SERVICE, XPathUtils.getString(source, X_HOURS_OF_SERVICE), address);
