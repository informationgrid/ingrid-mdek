...
public class MdekCallerQuery extends MdekCaller implements IMdekCallerQuery {
	...
	public IngridDocument updateByHQL(String plugId, List<Pair> hqlQueries) {
		IngridDocument jobParams = new IngridDocument();
		jobParams.put(IHQLExecuter.HQL_QUERIES, hqlQueries);

		List jobMethods = setUpJobMethod("updateByHQL", jobParams);
