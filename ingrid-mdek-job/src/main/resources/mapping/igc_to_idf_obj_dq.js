...
/*
    if (!hasValue(conformityRow.get("degree_key")) || conformityRow.get("degree_key") == "3")) {
...
*/
    ...
    if (conformityRow.get("degree_key") == "3") {
        // not evaluated
        dqConformanceResult.addElement("gmd:pass").addAttribute("gco:nilReason", "unknown");
    } else {
        // true or false
        dqConformanceResult.addElement("gmd:pass/gco:Boolean").addText((conformityRow.get("degree_key") == "1") + "");
    }
...
function addObjectDataQualityTable(objRow, dqDataQuality) {
    ...
    for (i=0; i<rows.size(); i++) {
        ...
        if (igcDqElementId == "109") {
            ...
            } else if (igcNameOfMeasureKey == "9") {
                // Number of watercourse links below threshold length
                dqElem.addElement("gmd:measureIdentification").addAttribute("gco:nilReason", "missing");
            } else if (igcNameOfMeasureKey == "10") {
                // Number of closed watercourse links
                dqElem.addElement("gmd:measureIdentification").addAttribute("gco:nilReason", "missing");
            } else if (igcNameOfMeasureKey == "11") {
