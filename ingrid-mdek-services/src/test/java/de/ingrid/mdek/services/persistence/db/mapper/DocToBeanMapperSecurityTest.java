...
public class DocToBeanMapperSecurityTest {
	...
	public void testMapIdcUser() {
		...
		inDoc.put(MdekKeysSecurity.IDC_ROLE, new Integer(MdekKeysSecurity.IDC_ROLE_CATALOG_ADMINISTRATOR));
		...
		Assert.assertEquals(user.getIdcRole().intValue(), MdekKeysSecurity.IDC_ROLE_CATALOG_ADMINISTRATOR);
		...
		inDoc.put(MdekKeysSecurity.IDC_ROLE, new Integer(MdekKeysSecurity.IDC_ROLE_METADATA_ADMINISTRATOR));
		try {
			DocToBeanMapperSecurity.getInstance(null).mapIdcUser(inDoc, user);
